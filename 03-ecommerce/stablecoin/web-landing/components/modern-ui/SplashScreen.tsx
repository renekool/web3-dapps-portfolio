  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-background/80 backdrop-blur-2xl">
      <div className="relative flex flex-col items-center">
        ...
        {/* VivaPay Logo Simulation */}
        <div className="relative mb-8 text-4xl font-extrabold tracking-tighter text-primary font-[family-name:var(--font-sans)] animate-bounce-slow">
