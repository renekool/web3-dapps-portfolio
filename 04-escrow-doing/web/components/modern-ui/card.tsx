...
const cardVariants = cva("group relative overflow-hidden rounded-xl transition-all duration-300", {
  variants: {
    variant: {
      ...
      outline: "bg-card border-1 border-primary/20 hover:border-primary/40",
      destructive: "bg-destructive text-destructive-foreground",
      dashed: "bg-card border-1 border-dashed border-border",
      elevated: "bg-card border border-border shadow-lg",
      interactive: "bg-card border border-border hover:scale-[1.01] hover:shadow-md",
    },
    size: {
      default: "p-6",
      sm: "p-4",
